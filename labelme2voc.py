...
def main():
    ...
    parser.add_argument("output_dir", help="output dataset-catdog directory")
    ...
    print("Creating dataset-catdog:", args.output_dir)
    ...
    for filename in glob.glob(osp.join(args.input_dir, "*.json")):
        print("Generating dataset-catdog from:", filename)
